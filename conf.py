...
extensions = ['gdscript', 'sphinx_tabs.tabs', 'sphinx.ext.mathjax', 'sphinx.ext.todo', 'sphinx_copybutton']
...
html_theme_options = {
    ...
    'flyout_display': 'attached',  # Attach flyout to sidebar instead of floating
}
